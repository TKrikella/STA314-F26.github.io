...
format: 
  live-revealjs:
    ...
    scrollable: true
    slide-number: "c/t"
    footer: '<div style="font-size: 15px; display: flex; justify-content: space-between; width: 92%; margin-left: 4em;"><span style="flex: 1; text-align: left;">STA314: Statistical Methods for Machine Learning I</span><span style="flex: 1; text-align: center;">Shrinkage and Regularization</span><span style="flex: 1;"></span></div>'
    smaller: true
    menu: 
      side: right
      width: wide
...
-   Explain how regularization trades a small increase in bias for a reduction in variance.
