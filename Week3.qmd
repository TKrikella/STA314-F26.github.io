...
A real-estate company wants to predict the sale price of homes using variables such as square footage, number of bedrooms, number of bathrooms, lot size, age of the home, distance to downtown, school quality, neighbourhood income, nearby transit access, and property taxes.

<br> 

The company believes that many of these predictors may contain useful information, although some are strongly correlated with one another.

<br> 

Would you prefer ridge regression or the lasso for this problem? What factors would influence your choice?
